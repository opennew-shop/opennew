#!/bin/bash
# ANCF vUSDC — Transfer mint authority to 2-of-3 multisig
...
if [ $# -lt 2 ]; then
    ...
    echo ""
    echo "Transfers mint authority of the vUSDC Token-2022 mint"
...
echo "╔══════════════════════════════════════════════╗"
echo "║  ANCF vUSDC — Mint Authority Transfer        ║"
echo "╚══════════════════════════════════════════════╝"
echo ""
