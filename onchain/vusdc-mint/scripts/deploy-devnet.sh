...
echo "╔══════════════════════════════════════════════╗"
echo "║  ANCF vUSDC Token-2022 Devnet Deployment     ║"
echo "╚══════════════════════════════════════════════╝"
echo ""
...
# ── 5. Deploy ──
echo ""
echo "[5/6] Deploying vUSDC mint..."

DESTINATION="${DESTINATION:-Giqt4TrXHzkPBYSD4Rs9K9VB6BVqznsWnmyPgVJKdhDw}"
MINT_AMOUNT="${MINT_AMOUNT:-1000000000000}"  # 1M vUSDC (6 decimals)
